...
public class LibraryContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<Book>().Property(book => book.ISBN).IsRequired().HasMaxLength(17);
		...
		modelBuilder.Entity<Member>().Property(member => member.Name).IsRequired().HasMaxLength(100);
